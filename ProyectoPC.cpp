...
bool autorizaReporte(EstructuraReporte*& reporte,int supDer,int infDer,int supIzq,int infIzq,int neta); //Esta es la funcion getNombreArchivoInteresadosR pero retorna 0 o 1
